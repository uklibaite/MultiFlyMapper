function [flyData,runData,p] = multiFlySegmentAndAlignHist(startFrame,endFrame,p)
...
runData.history1 = history1;
runData.history2 = history2;
runData.history3 = history3;
